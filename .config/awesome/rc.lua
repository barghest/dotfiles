...
theme_path = "/home/thomas/.config/awesome/themes/default/theme.lua"
...
globalkeys = awful.util.table.join(
  --  awful.key({ modkey,           }, "Left",   awful.tag.viewprev       ),
   -- awful.key({ modkey,           }, "Right",  awful.tag.viewnext       ),
    ...
    awful.key({ modkey,           }, "F2", function () awful.util.spawn(runcmd) end),
